...
const DriverRegisterModal = ({ driver, onClose, onSuccess }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Permite ver el mensaje durante 1.8 segundos antes de cerrar el modal
            setTimeout(() => {
    ...
    return (
        <div style={modalOverlayStyle}>
            <div style={modalContentStyle}>
                ...
                {errorMessage && (
                    <div style={errorMessageStyle}>
                        ...
                        <button type="button" onClick={() => setErrorMessage('')} style={closeAlertBtnStyle}>×</button>
                    </div>
                )}
                ...
                <form onSubmit={handleSubmit} style={formStyle}>
                    ...
                    <div style={photoSectionStyle}>
                        ...
                        <div style={photoColumnStyle}>
                            ...
                            <div style={previewBoxStyle} onClick={() => formData.foto && setPreviewImage(formData.foto)}>
                        ...
                        <div style={photoColumnStyle}>
                            ...
                            <div style={previewBoxStyle} onClick={() => formData.foto_vehiculo && setPreviewImage(formData.foto_vehiculo)}>
                        ...
                        <div style={photoColumnStyle}>
                            ...
                            <div style={previewBoxStyle} onClick={() => formData.foto_documento && setPreviewImage(formData.foto_documento)}>
            ...
            {previewImage && (
                <div style={lightboxStyle} onClick={() => setPreviewImage(null)}>
                    <img src={previewImage} alt="Previsualización" style={lightboxImgStyle} />
                </div>
            )}
        </div>
    );
...
const previewBoxStyle = { width: '100%', height: '100px', backgroundColor: '#fcfcfc', borderRadius: '12px', border: '2px dashed #eee', display: 'flex', justifyContent: 'center', alignItems: 'center', overflow: 'hidden', color: '#ddd', fontSize: '1.8rem', boxSizing: 'border-box', cursor: 'pointer' };
...
// Estilos de Alertas y Lightbox
const errorMessageStyle = { backgroundColor: '#f8d7da', color: '#721c24', padding: '12px 16px', borderRadius: '8px', marginBottom: '15px', border: '1px solid #f5c6cb', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.9rem' };
const successMessageStyle = { backgroundColor: '#d4edda', color: '#155724', padding: '12px 16px', borderRadius: '8px', marginBottom: '15px', border: '1px solid #c3e6cb', fontSize: '0.9rem', textAlign: 'center', fontWeight: 'bold' };
const closeAlertBtnStyle = { background: 'none', border: 'none', fontSize: '1.2rem', color: '#721c24', cursor: 'pointer', fontWeight: 'bold' };
const lightboxStyle = { position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: 'rgba(0,0,0,0.85)', display: 'flex', justifyContent: 'center', alignItems: 'center', zIndex: 3000, cursor: 'pointer' };
const lightboxImgStyle = { maxWidth: '90%', maxHeight: '90%', borderRadius: '8px', boxShadow: '0 0 20px rgba(255,255,255,0.2)' };
