...
//     // Determinamos si es una edición basada en si ya tiene repartidor_id
//     const isEditing = !!driver.repartidor_id;
...
//         tipo_documento: driver.tipo_documento || 'CI',
//         tipo_vehiculo_id: driver.tipo_vehiculo_id || '', 
//         vehicleDescript: driver.tipo_vehiculo || '',   
//         foto: driver.foto || '',
//         foto_vehiculo: driver.foto_vehiculo || ''
//     });
...
//                 // Si es un registro nuevo, inicializar con el primero
//                 if (!isEditing && response.data.length > 0 && !formData.tipo_vehiculo_id) {
//                     setFormData(prev => ({ 
//                         ...prev, 
...
//         setLoading(true);
//         try {
//             // Se usa el mismo endpoint, el backend debería manejar el upsert (update or insert)
//             await axios.post(`${API_BASE_URL}/driver/driver-register-modal`, formData, { withCredentials: true });
//             alert(isEditing ? "¡Registro actualizado!" : "¡Registro exitoso!");
//             onSuccess();
//             onClose();
...
//                                 border: 'none',
//                                 color: '#fff',
//                                 // CAMBIO DINÁMICO DE COLOR: Verde si es nuevo, Azul si es edición
//                                 backgroundColor: isEditing ? '#2c3e50' : '#28a745',
