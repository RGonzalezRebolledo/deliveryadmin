...
//     const [drivers, setDrivers] = useState([]);
//     const [searchTerm, setSearchTerm] = useState("");
//     const [statusFilter, setStatusFilter] = useState("todos"); // Estado para el filtro de estatus
//     const [loading, setLoading] = useState(true);
//     const [showModal, setShowModal] = useState(false);
//     const [selectedDriver, setSelectedDriver] = useState(null);
...
//     // LÓGICA DE FILTRADO (Buscador + Filtro de Estatus)
//     const filteredDrivers = drivers.filter((d) => {
//         const query = searchTerm.toLowerCase();
//         const estatusReal = !d.repartidor_id ? 'pendiente' : d.is_active.toLowerCase();

//         const coincideBusqueda = d.nombre.toLowerCase().includes(query) || d.email.toLowerCase().includes(query);
//         const coincideEstatus = statusFilter === "todos" || estatusReal === statusFilter;
...
//             await axios.put(endpoint, { usuario_id: driver.usuario_id }, { withCredentials: true });
...
//                         <span style={{ fontSize: '0.8rem', color: '#777' }}>
//                             Mostrando <strong>{filteredDrivers.length}</strong> de {drivers.length}
//                         </span>
//                     </div>
...
//                                         border: 'none', background: 'none', color: '#999', cursor: 'pointer', fontSize: '1.2rem'
//                                     }}
//                                 >×</button>
//                             )}
//                         </div>
...
//                                                     <button
//                                                         className="btn-success"
//                                                         style={{ fontSize: '0.7rem', padding: '6px 12px', minWidth: '90px' }}
...
//                                                     <button
//                                                         style={{
//                                                             fontSize: '0.7rem', padding: '6px 12px', minWidth: '90px',
//                                                             backgroundColor: '#00BFFF', color: '#fff', border: 'none', borderRadius: '5px', fontWeight: 'bold'
//                                                         }}
//                                                         onClick={() => handleAction(d, 'activar')}
//                                                     >
//                                                         Activar
